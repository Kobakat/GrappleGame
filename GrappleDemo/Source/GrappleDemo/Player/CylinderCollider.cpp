...
UCylinderCollider::UCylinderCollider() { PrimaryComponentTick.bCanEverTick = true; }
UCylinderCollider::~UCylinderCollider() { }

void UCylinderCollider::BeginPlay()
{
...
void UCylinderCollider::TickComponent(float deltaTime, enum ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
FVector UCylinderCollider::CalculateBounds()
{
	return GetStaticMesh()->GetBounds().BoxExtent;
}


void UCylinderCollider::HandleStandUp(float deltaTime)
{
	//TODO sweep by multi
...
bool UCylinderCollider::CheckIfGrounded()
{
	FCollisionQueryParams param;
	param.AddIgnoredActor(player);
...
bool UCylinderCollider::CheckIfLedgeGrabEligible()
{
...
bool UCylinderCollider::CheckIfLedgeGrabEligible(FVector playerMoveVector)
{
	//Start by sweeping our player region for a ledge
...
bool UCylinderCollider::CheckIfTryingToStand()
{
